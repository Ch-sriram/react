...
5. Section wrap-up & Assignment: [My Solution in JavaScript](https://codesandbox.io/s/staging-morning-offcj?file=/src/App.js), [Instructor's Solution in Javascript](https://codesandbox.io/s/blissful-rosalind-fu2gm?file=/src/App.js) & **[My Solution in TypeScript](https://codesandbox.io/s/jovial-browser-3ycz0)** ([Use App](https://3ycz0.csb.app/))
...
4. Adding & Using **[Styled Component](https://styled-components.com/)** &mdash; `npm i --save styled-components` 💄
   ...
   3. Dynamic styling with `props` inside a tagged template string: [Commit Details](https://github.com/Ch-sriram/react/commit/55bceb0995517afb22f04d569f308fb69d9d041b) & **[Do the same in TypeScript](https://github.com/styled-components/styled-components/issues/630#issuecomment-315475109)**
...
11. Setting State Correctly using `setState((prevState, props) => ({...prevState, }));`: [Commit Details](https://github.com/Ch-sriram/react/commit/754d0e2224ca28708ca4c8cff59bad73aa4cbda9)
