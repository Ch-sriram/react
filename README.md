...
3. Integrating Redux into React ⚛🔌♻
   ...
   3. Dispatching **`ACTION`**s from within a React Component: [Commit Details](https://github.com/Ch-sriram/react/commit/084ebfea2ff011e37db2f7232d5e1792f6a4865a) | **[Assignment Solution @CodeSandBox](https://codesandbox.io/s/angry-galileo-85ptp?file=/src/containers/Counter/Counter.js)** | **[Commit Details for Assignment]()**
